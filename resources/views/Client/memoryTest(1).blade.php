    ...
    <div class="navbar" style="padding-top: 0px; ">
        <div class="container2">
            ...
            <ul>
                    ...
                    <li><a href="#"> {{__('myCustom.mri')}}</a></li>
                    <li><a href="#"> {{__('myCustom.memory')}}</a></li>
...
<!-- end of modal of quiz details-->
    ...
    <script >
        const questions = [
        {
            question: "{{__('myCustom.q1')}}",
            optionA: "{{__('myCustom.q1-y')}}",
            optionB: "{{__('myCustom.q1-n')}}",
            correctOption: "optionA"
        },

        {
            question: "../__('myCustom.edit')",
            optionA: "10 players",
            optionB: "11 players",
            optionC: "9 players",
            optionD: "12 players",
